...
<body>
    ...
    <main class="page-shell">
        <section class="hero-panel">
            ...
            <h1>Vraag een nieuwe toegang aan in dezelfde stijl.</h1>
            <p class="lead">
                Deze pagina sluit nu visueel aan op de login- en homepage: hetzelfde warme palette, dezelfde premium panelopbouw en dezelfde rustige, zakelijke uitstraling.
            </p>
            ...
            <ul class="hero-points">
                <li>Voer het e-mailadres van je account in</li>
                <li>Ontvang een resetlink via de bestaande Laravel-flow</li>
                <li>Kies daarna een nieuw wachtwoord en log opnieuw in</li>
            </ul>
        </section>

        <section class="form-panel">
            <h2>Forgot password</h2>
            <p class="helper">Vul je e-mailadres in en we sturen je een link om je wachtwoord opnieuw in te stellen.</p>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <button type="submit" class="pill pill--strong" data-test="email-password-reset-link-button">
            ...
            <p class="side-note">De onderliggende resetfunctionaliteit blijft dezelfde Laravel Fortify-flow gebruiken.</p>
        </section>
    </main>
</body>
</html>
