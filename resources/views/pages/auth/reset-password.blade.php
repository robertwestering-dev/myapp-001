...
<body>
    ...
    <main class="page-shell">
        <section class="hero-panel">
            ...
            <h1>Kies een nieuw wachtwoord in dezelfde vertrouwde stijl.</h1>
            <p class="lead">
                Ook de reset-password pagina sluit nu visueel aan op de andere auth-schermen, met dezelfde rustige premium uitstraling en duidelijke formulieropbouw.
            </p>
            ...
            <ul class="hero-points">
                <li>Vul hetzelfde e-mailadres in als bij het account</li>
                <li>Kies een nieuw veilig wachtwoord</li>
                <li>Na het resetten kun je direct opnieuw inloggen</li>
            </ul>
        </section>

        <section class="form-panel">
            <h2>Reset password</h2>
            <p class="helper">Voer hieronder je e-mailadres en nieuwe wachtwoord in om je accounttoegang te herstellen.</p>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <button type="submit" class="pill pill--strong" data-test="reset-password-button">
                    Reset password
                </button>
            </form>
            ...
            <p class="side-note">De reset-flow blijft gebruikmaken van dezelfde Laravel Fortify-validatie en beveiliging als voorheen.</p>
        </section>
    </main>
</body>
</html>
